...
#TAULA.Ulcera/Pie Diabético/Amputaciones(Primaria+Hospital)
...
table1::table1(formu,
               data = dt_plana_exc,caption = "Taula 00.Variables TOTALES /Antecedentes  UEIPA  -ulcera+pie+amputacion- (Primaria+Hospital).Descriptiva general",
