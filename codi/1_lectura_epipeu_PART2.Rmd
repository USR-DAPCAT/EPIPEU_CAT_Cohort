...
dtagr_facturat_2018_EPIPEU5<-agregar_facturacio(
  dt=dtagr_facturacio,
  bd.dindex=dt_index,
  finestra.dies=c(-90,0),
...
```{r agregacio_facturacio365, include=F}

#02.4.2021

dtagr_facturat_2018_EPIPEU6<-agregar_facturacio(
  dt=dtagr_facturacio,
  bd.dindex=dt_index,
...
dtagr_facturat_2018_EPIPEU7<-agregar_facturacio(
  dt=dtagr_facturacio,
  bd.dindex=dt_index,
  finestra.dies=c(-365,0),
  dt.agregadors=select(dt_cataleg4,cod,agr=agr_Insul_Ado),
...
dtagr_facturat_2018_EPIPEU8<-agregar_facturacio(
  dt=dtagr_facturacio,
  bd.dindex=dt_index,
  finestra.dies=c(-365,0),
  dt.agregadors=select(dt_cataleg4,cod,agr=agr_Niad),
...
dtagr_variables_2018_EPIPEU<-agregar_analitiques(dt=dt_variables,bd.dindex=dt_index,finestra.dies = c(-365,0))
...
dtagr_tabac_2018_EPIPEU<-agregar_analitiques(dt=dt_tabaquisme,bd.dindex=dt_index,finestra.dies = c(-Inf,0))
...
#[5]#
dtagr_facturat_2018_EPIPEU5<-dtagr_facturat_2018_EPIPEU5 %>% mutate(dtindex=data.to.string(dtindex) %>% as.numeric())

#[6]#
dtagr_facturat_2018_EPIPEU6<-dtagr_facturat_2018_EPIPEU6 %>% mutate(dtindex=data.to.string(dtindex) %>% as.numeric())


#[7]#
dtagr_facturat_2018_EPIPEU7<-dtagr_facturat_2018_EPIPEU7 %>% mutate(dtindex=data.to.string(dtindex) %>% as.numeric())


#[8]#
dtagr_facturat_2018_EPIPEU8<-dtagr_facturat_2018_EPIPEU8 %>% mutate(dtindex=data.to.string(dtindex) %>% as.numeric())
