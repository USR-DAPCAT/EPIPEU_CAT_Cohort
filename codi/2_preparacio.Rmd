...
#15)COLESTEROL LDL LDL.COLESTEROL.LDL, <70 , 70-99, 100-129 y >o=130
...
#3)Insuficiencia renal cronica : Insuficiencia Renal Cronica: #[diagnostico +segun valores de FG, FG<60]
dt_plana<-dt_plana%>%mutate(DG.IRC2=ifelse(DG.INS_RNC==1  | (CKDEPI.valor<60 |CAC.valor>29)  ,1,0)) 

#4)Nefropatia diabetica: [diagnostico nefropatia diabetica y(diagnostico de insuficiencia #renal y/o proteinuria y/o  [FG, FG<60 y/o CAC>30])
...
#5)Nefropatia diabe?tica: diagnostico + CAC>300  mg/24h
dt_plana<-dt_plana%>%mutate(DG.NEFRPDM2=ifelse(DG.NEFRPDM==1 & CAC.valor>300 ,1,0)) 


#6)Arteriopatia periferica : diagnostico registrado o el valor de ITB (<0.9)
dt_plana<-dt_plana%>%mutate(DG.ARTPER2=ifelse(DG.ARTPER==1 | (ITB_Dret.valor<0.9),1,0))



#7)#Prevencio Secundiria![CardioVasculars]
...
#8)Prevencio Primaria![No CardioVasculars]
