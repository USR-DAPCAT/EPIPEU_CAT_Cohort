...
diagrama_Consort4b<-function(dt=dades,TITOL="capullo",TRACT="FF.HTA",GRUP2=TRUE)
  {
...
diagrama_Consort5b<-function(dt=dades,TITOL="capullo",TRACT="FF.HTA",GRUP2=TRUE)
  {
...
diagrama_Consort<-function(dt=dades,EXCLUSIONS=K1,TITOL="LALA",TRACT="FF.HTA",GRUP2=FALSE)
 ...
 if ( nEXC==1) {diagrama_Consort1b(dt=dades,TITOL=TITOL,TRACT=TRACT,GRUP2=GRUP2)}
 else if ( nEXC==2) {diagrama_Consort2b(dt=dades,TITOL=TITOL,TRACT=TRACT,GRUP2=GRUP2)}
 else if ( nEXC==3) {diagrama_Consort3b(dt=dades,TITOL=TITOL,TRACT=TRACT,GRUP2=GRUP2)}
 else if ( nEXC==4) {diagrama_Consort4b(dt=dades,TITOL=TITOL,TRACT=TRACT,GRUP2=GRUP2)}
 else if ( nEXC==5) {diagrama_Consort5b(dt=dades,TITOL=TITOL,TRACT=TRACT,GRUP2=GRUP2)}  
...
EXC=c("exclusio1")
EXC_LAB=c("A")
P1a<-diagrama_Consort(dt=dades,EXCLUSIONS=EXC,TITOL="BURRO",TRACT="FF.HTA",GRUP2=FALSE)
P1b<-diagrama_Consort(dt=dades,EXCLUSIONS=EXC,TITOL="BURRO",TRACT="FF.HTA",GRUP2=TRUE)



EXC=c("exclusio1","exclusio2")
EXC_LAB=c("A","B")
P2a<-diagrama_Consort(dt=dades,EXCLUSIONS=EXC,TITOL="BURRO",TRACT="FF.HTA",GRUP2=FALSE)
P2b<-diagrama_Consort(dt=dades,EXCLUSIONS=EXC,TITOL="BURRO",TRACT="FF.HTA",GRUP2=TRUE)


EXC=c("exclusio1","exclusio2","exclusio3")
EXC_LAB=c("A","B","C")
P3a<-diagrama_Consort(dt=dades,EXCLUSIONS=EXC,TITOL = "KKK",TRACT="FF.HTA",GRUP2=FALSE)
...
EXC_LAB=c("A","B","C","D")
P4a<-diagrama_Consort(dt=dades,EXCLUSIONS=EXC,TITOL = "KKK",TRACT="FF.HTA",GRUP2=FALSE)
P4b<-diagrama_Consort(dt=dades,EXCLUSIONS=EXC,TITOL = "KKK",TRACT="FF.HTA",GRUP2=TRUE)

EXC=c("exclusio1","exclusio2","exclusio3","exclusio4","exclusio5")
EXC_LAB=c("A","B","C","D","E")
P5a<-diagrama_Consort(dt=dades,EXCLUSIONS=EXC,TITOL = "KKK",TRACT="FF.HTA",GRUP2=FALSE)
P5b<-diagrama_Consort(dt=dades,EXCLUSIONS=EXC,TITOL = "KKK",TRACT="FF.HTA",GRUP2=TRUE)
