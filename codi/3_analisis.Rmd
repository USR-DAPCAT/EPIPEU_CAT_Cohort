...
diagrama_Consort<-function(dt=dades,EXCLUSIONS=K1,TITOL="LALA")
 ...
 if ( nEXC==1) {
   diagrama_Consort1(dt=dades,TITOL = TITOL)}
 else if ( nEXC==2) {
   diagrama_Consort2(dt=dades,TITOL = TITOL)}
 else if ( nEXC==3) {
   diagrama_Consort3(dt=dades,TITOL = TITOL)}
 else if ( nEXC==4) {
   diagrama_Consort4(dt=dades,TITOL = TITOL)}
 else if ( nEXC==5) 
   {diagrama_Consort5(dt=dades,TITOL = TITOL)}  
...
EXC=c("exclusio1")
EXC_LAB=c("A")
P1<-diagrama_Consort(dt=dades,EXCLUSIONS=EXC,TITOL="PUTA")

EXC=c("exclusio1","exclusio2")
EXC_LAB=c("A","B")
P2<-diagrama_Consort(dt=dades,EXCLUSIONS=EXC,TITOL = "PUTA")

EXC=c("exclusio1","exclusio2","exclusio3")
EXC_LAB=c("A","B","C")
P3<-diagrama_Consort(dt=dades,EXCLUSIONS=EXC,TITOL = "CACA")
