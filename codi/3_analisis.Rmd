...
diagrama_Consort1<-function(dt=dades,TITOL="ggg")
  {
...
diagrama_Consort1b<-function(dt=dades,TITOL="ll",TRACT="FF.HTA",GRUP2=TRUE)
  {
...
diagrama_Consort2<-function(dt=dades,TITOL="PP")
  {
...
diagrama_Consort2b<-function(dt=dades,TITOL="kk",TRACT="FF.HTA",GRUP2=TRUE)
  {
...
diagrama_Consort3<-function(dt=dades,TITOL="TA")
  {
...
diagrama_Consort3b<-function(dt=dades,TITOL="capullo",TRACT="FF.HTA",GRUP2=TRUE)
  {
...
diagrama_Consort4<-function(dt=dades,TITOL="PA")
  {
...
study_cohorts <- 
  ...
  # anti_join is useful for counting exclusions -------------
  # [[anti_join és útil per comptar les exclusions]]  
    exclusio = anti_join(.full,  exclusio4, by = "idp"),
    exclusio1b = anti_join(.full, exclusio1, by = "idp"),
    exclusio2b = anti_join( exclusio1, exclusio2, by = "idp"),
    exclusio3b = anti_join( exclusio2, exclusio3, by = "idp"),
...
diagrama_Consort4b<-function(dt=dades,TITOL="PP",TRACT="FF.HTA",GRUP2=TRUE)
  {
...
diagrama_Consort5<-function(dt=dades,TITOL="TA")
  {
...
study_cohorts <- 
  ...
  # anti_join is useful for counting exclusions -------------
  # [[anti_join és útil per comptar les exclusions]]  
    exclusio = anti_join(.full,  exclusio5, by = "idp"),
    exclusio1b = anti_join(.full, exclusio1, by = "idp"),
    exclusio2b = anti_join( exclusio1, exclusio2, by = "idp"),
    exclusio3b = anti_join( exclusio2, exclusio3, by = "idp"),
    exclusio4b = anti_join( exclusio3, exclusio4, by = "idp"),
    exclusio5b= anti_join( exclusio4, exclusio4, by = "idp")
...
diagrama_Consort5b<-function(dt=dades,TITOL="PU",TRACT="FF.HTA",GRUP2=TRUE)
  {
...
KK1<-diagrama_Consort1(dt=dades,TITOL = "A")
KK2<-diagrama_Consort2(dt=dades,TITOL = "B")
KK3<-diagrama_Consort3(dt=dades,TITOL = "C")
KK3b<-diagrama_Consort3b(dt=dades,TITOL = "C",TRACT="FF.HTA",GRUP2 = TRUE)
KK3c<-diagrama_Consort3b(dt=dades,TITOL = "C",TRACT="FF.HTA",GRUP2 = FALSE)

KK4<-diagrama_Consort4(dt=dades,TITOL = "D")
KK5<-diagrama_Consort5(dt=dades,TITOL = "E")
...
diagrama_Consort<-function(dt=dades,EXCLUSIONS=K1,TITOL="LALA",TRACT="FF.HTA",GRUP2=FALSE)
 ...
 if ( nEXC==1) {diagrama_Consort1(dt=dades,TITOL = TITOL)}
 else if ( nEXC==2) {diagrama_Consort2(dt=dades,TITOL = TITOL)}
 else if ( nEXC==3) {diagrama_Consort3b(dt=dades,TITOL=TITOL,TRACT=TRACT,GRUP2=GRUP2)}
 else if ( nEXC==4) {diagrama_Consort4(dt=dades,TITOL = TITOL)}
 else if ( nEXC==5) {diagrama_Consort5(dt=dades,TITOL = TITOL)}  
 else if ( nEXC>5 ) {print("Flow-chart menys de 6 Exclusions")}
 else if  (  nEXC==0 )  {print("Possible Error, nop hi ha EXCLUSIONS!")}
...
EXC=c("exclusio1")
EXC_LAB=c("A")
P1<-diagrama_Consort(dt=dades,EXCLUSIONS=EXC,TITOL="BURRO")

EXC=c("exclusio1","exclusio2")
EXC_LAB=c("A","B")
P2<-diagrama_Consort(dt=dades,EXCLUSIONS=EXC,TITOL = "BURROS")

EXC=c("exclusio1","exclusio2","exclusio3")
EXC_LAB=c("A","B","C")
P3<-diagrama_Consort(dt=dades,EXCLUSIONS=EXC,TITOL = "KK")
P3b<-diagrama_Consort(dt=dades,EXCLUSIONS=EXC,TITOL = "KKK",TRACT="FF.HTA",GRUP2=TRUE)



EXC=c("exclusio1","exclusio2","exclusio3","exclusio4")
EXC_LAB=c("A","B","C","D")
P4<-diagrama_Consort(dt=dades,EXCLUSIONS=EXC,TITOL = "MOC")

EXC=c("exclusio1","exclusio2","exclusio3","exclusio4","exclusio5")
EXC_LAB=c("A","B","C","D","E")
P5<-diagrama_Consort(dt=dades,EXCLUSIONS=EXC,TITOL = "PET")
...
EXC=c("exclusio1")
EXC_LAB=c("COLA-CAU")
P7<-diagrama_Consort(dt=dades,EXCLUSIONS=EXC)
